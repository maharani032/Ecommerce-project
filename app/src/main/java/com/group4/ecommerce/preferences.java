...
public class preferences {
    ...
    public static void setDataUid(Context context, String data){
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString(DATA_UID,data);
        editor.apply();
    }

    public static String getDataUid(Context context){
        return getSharedPreferences(context).getString(DATA_UID,"");
    }
